...
class WebsiteSupportSLA(models.Model):
    ...
    response_time_ids = fields.One2many('website.support.sla.response', 'vsa_id', string="(DEPRICATED) Category Response Times (Working Hours)")
...
class WebsiteSupportSLARuleCondition(models.Model):
    ...
    category_id = fields.Many2one('website.support.ticket.categories', string="Category")
